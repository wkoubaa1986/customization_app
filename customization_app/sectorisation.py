"""Sectorisation géographique : gouvernorat -> ville -> secteur.

GÉNÉRÉ depuis public/js/customer_quick_entry.js (villes_par_gouvernorat)
le 27/08/2026 — les deux doivent rester en phase : le quick entry client
et le portail /rdv sectorisent avec la même table.
"""

VILLES_PAR_GOUVERNORAT = {
 "Ariana": {
  "Ariana ville": "Secteur 2",
